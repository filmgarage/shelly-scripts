...
|-----|------------------------|------|-------|-----------|
| 100 | Channel 1 Total Energy | kWh  | 0     | 999999999 |
| 101 | Channel 2 Total Energy | kWh  | 0     | 999999999 |
| 102 | Total Energy           | kWh  | 0     | 999999999 |

**Create 3 Number Components for Offsets:**

| ID  | Name             | Unit | Min        | Max       |
|-----|------------------|------|------------|-----------|
| 200 | Channel 1 Offset | kWh  | -999999999 | 999999999 |
| 201 | Channel 2 Offset | kWh  | -999999999 | 999999999 |
| 202 | Total Offset     | kWh  | -999999999 | 999999999 |
...
**Example:**
- Channel 1: 5,000,000 Wh = 5,000 kWh + 2,500 offset = **7,500 kWh**
- Channel 2: 3,000,000 Wh = 3,000 kWh + 1,000 offset = **4,000 kWh**
- Total: 7,500 + 4,000 + 0 total offset = **11,500 kWh**
...
curl "http://YOUR_SHELLY_IP/rpc/Number.Set?id=202&value=100"
```

### Understanding the Total Offset

The Total Offset is applied **after** summing the two adjusted channel values. This is useful for:
- Adding a baseline to the combined total
- Compensating for external factors affecting both channels
- Fine-tuning the total without changing individual channels

**Example:**
- Channel 1: 1,000 kWh + 500 offset = 1,500 kWh
- Channel 2: 2,000 kWh + 300 offset = 2,300 kWh
- Subtotal: 3,800 kWh
- Total Offset: +200 kWh
- **Final Total: 4,000 kWh**
...
**Solutions:**
- Verify all 7 virtual components are created (IDs: 100-102, 200-202, 300)
...
**Symptoms:** Total isn't the sum of Channel 1 and Channel 2

**Solution:** Check the Total Offset - it's applied after summing channels. Set it to 0 if you want Total = Channel 1 + Channel 2.
...
curl "http://YOUR_SHELLY_IP/rpc/Number.GetStatus?id=101"

# Get Total display value
curl "http://YOUR_SHELLY_IP/rpc/Number.GetStatus?id=102"
```
...
curl "http://YOUR_SHELLY_IP/rpc/Number.Set?id=201&value=OFFSET_IN_KWH"

# Set Total offset
curl "http://YOUR_SHELLY_IP/rpc/Number.Set?id=202&value=OFFSET_IN_KWH"
```
...
**Component IDs:**
- Display: 100-102 (Number components, kWh)
- Offsets: 200-202 (Number components, kWh)
